...
public class StringBuilder01 {
    public static void main(String[] args) {
        ...
        /*
        Javada String Class kullanilarak veya StringBuilder class kullanilarak olusturulabilir.
        String Class kullanilarak urettiginiz Stringler Immutable dir.(degistirilemezz)
        StringBuildr Class kullanarak urettiginiz Stringler Mutable dir {degistirilebilir}
         */
      String s="Java";
      String t=s+ "i";
      String w=t + "?";
      ...
      //mutable
        ...
        StringBuilder sb=new StringBuilder("Pyton");
        sb.append("!");//yeni bir class olusturmadan conteynirin icindeki deger degistirilir//strigi stringe yapistirir apend

        String a="Money";
        a=a+ "More";
        //Stringi degistirden sonra ayni Stringe atarsaniz Java yine yeni bir contaeynir olusturur.degismis degeri
        //yeni contaynerin icine koyar ve eski conteyniri gosteren oku yeni conteynira yonlendirir.
        //dolayisiyla eski container adressi zkalircve Garbage Collecter adressiz olan containeri
