...
public class Exceptions02 {
  ...
  //  public static void main(String[] args)throws IllegalArgumentException, ArithmeticException{{
       // try {//aplication donmasin diye yapariz...
         //   printAge(-18);
      //  } catch (IllegalArgumentException e) {
          //  System.out.println(e.getMessage());
       // }

        // throw keyword bir methodun bodysi icinde istedigimiz yerde istedigimiz kosullar,istedigimiz kadar   Exception atmamizi saglar
        //throw keyword yazildiktan sonra bir Exception class objecyi olusturur.
        //Exception class constructorun icine istedigimiz exception mesajini yazsbilirsinz.
