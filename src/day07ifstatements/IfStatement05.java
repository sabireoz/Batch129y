...
2) Heap Memory ==> Huge gibi
  ...
  //  adres'leri ile degil degerleri ile ilgileniriz. Bu yuzden String karsilastirmalarinda "==" kullanmayiz.
   ...
   // ihtiyac duydugumuz seydir.:string lerin esitliklerini kontrol ederken "==" yerine equals () kullaniriz.
   // niye?
   // cunku;"==" sembolu iki stringi karsilastiriken hem adreslerine hem degerlerine bakar.
