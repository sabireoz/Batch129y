...
public class C01_StringManipulations {
    ...
    public static void main(String[] args) {
        System.out.println("Yuz"+40+60);//yuz4060//string+int=string olur(concat yani yanina ekler)
        System.out.println("Yuz"+(40+60));//Yuz100==>parantez icerisini yapar yanyana yazar.
        ...
        //tam ismini buyuk harfle yazilmasini saglayin.

        Scanner input=new Scanner(System.in);
        System.out.println("Lutfen ad ve soyadinizi giriniz");
        String isim= input.nextLine(),soyad= input.nextLine();//multiple declarations
        ...
        ders.replace("a","@");
        System.out.println(ders.replace("a","@"));//*** **** **** **** ****ava gibi olsa
       // ol@g@nustu
