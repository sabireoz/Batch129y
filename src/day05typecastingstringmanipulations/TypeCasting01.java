...
public class TypeCasting01 {
    ...
    /*
    Numeric primitive data type larinin birbirine donusturulmesine denir.
    numerik data type lar byte-short-int-long-float-double
    not 1:Kucuk data type lerini buyuk data typelerine cevirmeyi Java otomatik olarak yapabilir.
    ...
    public static void main(String[] args) {
        ...
        //byte data type ni int data typene ceviriniz.

        byte age = 13;
        int ageInt = age;

        //long data typeni short data typene cevirelim.
        long weight =234;
        short weightInt=(short)weight;

        //int data type ni float data typene ceviriniz.
        ...
        //double dta typeni short data typene ceviriniz.
