...
public class Lambda02 {
  ...
  //  public static void main(String[] args) throws IOException {
        //Lambda text File dosyasi icindeki metni console yazdiran kodu yaziniz.
      //  Object TextFile;
        //Files.lines(Paths.get("src/day37lambda/Lambda TextFile.txt")).forEach(System.out::println);

     //2)LambdaTextFile dosyasi icindeki her characteri uppercase yapiniz.

   //  Files.
           //  lines(Paths.get("src/day37lambda/Lambda TextFile.txt")).
             //map(String::toUpperCase).forEach(System.out::println);
//
     //3)Lambda TextFile dosyasi icinde herhangi bir kelimenin var olup olmadigini gosteren kodu yaziniz.

       // Files.lines(Paths.get("src/day37lambda/Lambda TextFile.txt")).
            //    map(t->t.split("")).
              //  flatMap(Arrays::stream).//Arrayleri dumduz edr kirar ve stream e cevirir.
             //   anyMatch(t->t.contains("Java"));//streamdeki kelimelerin arasinda java kelimesi var mi?
       // System.out.println(result);
   // }


    //4 Lambda textFile dosyasi icindeki her kelimenin a icerip icermedigini gosteren kodu yaziniz.

   // boolean result2=Files.
            //  lines(Paths.get("src/day37lambda/Lambda TextFile.txt")).map(t->t.split("")).
          //  flatMap(Arrays::stream).allMatch(t->t.contains("a"));//her kelime a icerirse true verir.
