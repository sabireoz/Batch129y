...
StringBuilder sb2= new StringBuilder("Mehmet"); // icinde Mehmet degeri
olan bir SB uretir
System.out.println("sb2 : " + sb2);// Mehmet
StringBuilder sb3= new StringBuilder(10); // 10 karakter kapasitesi olan
bir SB uretir
System.out.println("sb3 : " + sb3);//
Verilen SB nin sonuna String (concat)ekleme:
sb1.append(" ").append("Cetinturk");  // verilen SB'in sonuna istedigimiz
String degerlerini ekler
System.out.println(sb1); // Rumeysa Cetinturk

Verilen SB nin sonuna String in bir kısmını ekleme:
String cumle="Javayi cok sever";
sb1.append(cumle, 6, 10); // Baska bir String'den istedigimiz bolumu SB'in
sonuna ekler
...
System.out.println(sb1.capacity()); //23 (7 +16) SB'in kapasite bilgisini
verir. (kapasite= SB obje oluşturulduğunda constructor parantezine
kapasitesi yazılabilir, o kapasiteyi doldurmak zorunda değiliz, doldurana
kadar String girdiğimizde kapasitesini sorarsak, ilk yazdığımız kapasiteyi
verir,kapasite  yazılmazsa 16 atanır.)
İstenilen index teki karakteri bulma(charAt gibi):
System.out.println(sb1.charAt(1));// u SB'in istedigimiz indexde olan
karakterin bilgisini verir
sb1.charAt(5); // Bize bilgi getiren methodlar SB'i degistirmez
System.out.println(sb1); //Rumeysa Cetinturk cok
İstenilen index teki yada iki index arasındaki karakteri silme:
sb1.delete(17, 21); // SB'in istedigimiz index'leri arasindaki kismini
siler (yine 17 dahil 21 hariç)
System.out.println(sb1); // //Rumeysa Cetinturk
...
System.out.println(sb1.indexOf("e", 6)); // 9.. istedigimiz indexten
sonrasinda arama yapar
System.out.println(sb1.indexOf("Kazim")); // -1 aradigimiz String'i SB'da
bulamazsa -1 döndürür
SB nin istenilen yerine String in verilen index lerdeki karakterlerini
ekleme:
...
System.out.println(sb1.lastIndexOf("t")); //22 istenen String'in
kullanildigi son indexi verir
System.out.println(sb1.lastIndexOf("a", 22 )); //14 istenen indexten
oncesine bakar
SB nin istenilen index leri arasını, verilen String ile değiştirme:
sb1.replace(8, 16, "Seher"); // SB'in baslangic ve bitis index'leri
arasindaki kismi
...
SB nin istenilen index ler arasındaki karakterini verme (substring gibi):
(bilgi verir, SB yi değiştirmez)
System.out.println(sb1.subSequence(8, 13)); // Seker  SB'in istedigimiz
index'ler
...
System.out.println(sb1.equals(isim)); // false verir.. data turleri farkli
oldugu icin
// icerigin kiyaslanmasi mumkun degildir
StringBuilder sb2= new StringBuilder("Rumeysa Cetintur");
System.out.println(sb1==sb2); // false
System.out.println(sb1.equals(sb2)); // false SB'da equals method"u
String'den farkli calisir
...
// iceriklerinin esit olup olmadigina bakmak icin String'deki equals
method'unu kullanalim
SB yi String e çevirme:
System.out.println(sb3.toString().equals(sb4.toString())); // true
sb3.toString().concat(" Insanin sevdikce sevesi geliyor"); // String
class'ina ait methodlar
...
System.out.println(sb3.toString().concat(" Insanin sevdikce sevesi
geliyor"));
